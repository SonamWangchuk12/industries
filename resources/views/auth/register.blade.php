                    ...
                    <form method="POST" action="{{ route('register') }}">
                        ...
                        <div class="form-group row">
                            ...
                            <div class="col-md-6">
                                ...
                                <input type="hidden" name="pawd" id="pawd" />
                            </div>
                        </div>

                        <div class="form-group row mb-0">
                            <div class="col-md-6 offset-md-4">
                                <button type="submit" class="btn btn-primary"  onclick="return encrypt()" >
                                    {{ __('Register') }}
                                </button>
                            </div>
                        </div>
...
var passw=  /^(?=.*\d)(?=.*[a-z])(?=.*[A-Z])(?=.*[^a-zA-Z0-9])(?!.*\s).{6,30}$/;
    ...
    {
        alert("passwords dont match required format");
    return false;
    }
...
var hash2 = CryptoJS.SHA256(pwd2);
hash=hash.toString();
hash2=hash2.toString();
document.getElementById('password').value=hash;
document.getElementById('password-confirm').value=hash2;
