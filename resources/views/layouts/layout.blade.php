...
<main>
  ...
  <section id="topbar" class="fixed-top d-flex align-items-center">
    <div class="container d-flex align-items-center justify-content-between">
       ...
       <a href="index.html" class="logo"><img src="assets/img/logoline.png" alt="" class="img-fluid"></a>
       <a href="index.html" class="logo"><img src="assets/img/g20.png" alt="" class="img-fluid"></a>
      {{-- <h1 class="logo"><a href="index.html">Urban Development Department</a></h1> --}}
          ...
          <div class="container d-flex align-items-center justify-content-between">
            ...
            <nav id="navbar" class="navbar">
              <ul>
                ...
                <li><a class="nav-link scrollto" href="#about">RTI</a></li>
