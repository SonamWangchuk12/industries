        ...
        <div class="col-md-12">
          <table id="datatable" class="table data-tables table-striped">
            ...
            <tr>
              ...
              <tr>
                <th scope="row">15.</th>
                <td>Offices Under Department</td>

                    <td> <a href="{{route('officesofdepts.create')}}">
                    <i class="fas fa-edit"></i></td>

                    <td> <a href="{{route('officesofdepts.index')}}">
                    <i class="fas fa-edit"></i></td>

              </tr>
              <tr>
                <th scope="row">15.</th>
                <td>Officer Directory</td>

                    <td> <a href="{{route('officerdirectories.create')}}">
                    <i class="fas fa-edit"></i></td>

                    <td> <a href="{{route('officerdirectories.index')}}">
                    <i class="fas fa-edit"></i></td>
              ...
              <tr>
                ...
                <td>Important Links</td>
                    ...
                    <td> <a href="{{route('implinks.create')}}">
                    <i class="fas fa-edit"></i></td>

                    <td> <a href="{{route('implinks.index')}}">
                    <i class="fas fa-edit"></i></td>
              ...
              <tr>
                ...
                <td>PSU</td>
                    ...
                    <td> <a href="{{route('psus.create')}}">
                    <i class="fas fa-edit"></i></td>

                    <td> <a href="{{route('psus.index')}}">
                    <i class="fas fa-edit"></i></td>

              </tr>
              <tr>
                <th scope="row">16.</th>
                <td>Awards And Achivements</td>

                    <td> <a href="{{route('awards.create')}}">
                    <i class="fas fa-edit"></i></td>

                    <td> <a href="{{route('awards.index')}}">
                    <i class="fas fa-edit"></i></td>

              </tr>
              <tr>
                <th scope="row">16.</th>
                <td>Industries and Companies</td>

                    <td> <a href="{{route('companies.create')}}">
                    <i class="fas fa-edit"></i></td>
