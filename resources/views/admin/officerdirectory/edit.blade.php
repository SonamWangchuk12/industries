               ...
               <div class="card">
                   <div class="card-header d-flex justify-content-between">
                       <div class="header-title">
                           <h4 class="card-title">Edit Officer Directory</h4>
                       </div>
                   </div>
                   <div class="card-body">
                       <form action="{{route('officerdirectories.update',[$dics->id])}}"  method="POST" enctype="multipart/form-data" data-toggle="validator">
                        @csrf
                        @method('PATCH')
                           <div class="row">
                               <div class="col-md-12">
