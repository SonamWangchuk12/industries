               ...
               <div class="card">
                   <div class="card-header d-flex justify-content-between">
                       <div class="header-title">
                           <h4 class="card-title">Edit Organization List</h4>
                       </div>
                   </div>
                   <div class="card-body">
                       <form action="{{route('orgstructures.update',[$orgstructures->id])}}"  method="POST" enctype="multipart/form-data" data-toggle="validator">
                        @csrf
                        @method('PATCH')
                           <div class="row">
                               <div class="col-md-12">
